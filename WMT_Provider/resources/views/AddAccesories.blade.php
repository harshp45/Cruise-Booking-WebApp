      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12">
            ...
            <form class="form-horizontal" action='/listaccesories' method="post" align="center">
...
{{csrf_field()}}
    ...
    <tr>
     ...
     <td>   <input type="text" id="username" name="description" placeholder="Enter Description" class="input-xlarge"></td>
        <!--     -->
      <p></p>
</tr>
    </div>
    ...
    <tr>
     ...
     <td align="center">   <input type="text" id="image" name="price" placeholder="Enter Price" ></td>
        <!--     -->
      <p></p>
</tr>
    </div>
