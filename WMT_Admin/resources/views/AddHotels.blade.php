    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                ...
                <form class="form-horizontal" action='/listhotels' method="post" align="center">
                        ...
                        <fieldset>
                            ...
                            <div class="control-group">
                                <tr>
                                    ...
                                    <td>   <input type="text" id="place" name="place" placeholder="Enter Place Name" class="input-xlarge"></td>
                                    <!--     -->
                                    <p></p>
                                </tr>
                            </div>
                            ...
                            <div class="control-group">
                                <tr>
                                    ...
                                    <td><input type="text" id="description" name="description" placeholder="Enter Description" class="input-xlarge"></td>
                                    <!--     -->
                                    <p></p>
                                </tr>
                            </div>
                            ...
                            <div class="control-group">
                                <tr>
                                    ...
                                    <td>   <input type="text" id="username" name="ratings" placeholder="Enter Ratings" class="input-xlarge"></td>
                                    <!--     -->
                                    <p></p>
                                </tr>
                            </div>
