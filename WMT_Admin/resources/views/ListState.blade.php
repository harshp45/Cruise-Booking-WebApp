...
<div id="page-content-wrapper">
    ...
    <tr >
        ...
        <td colspan="1"><a href="/addstate"><button class="btn btn-primary">Add</button></a></td>
      </tr>
      <tr class="th">
    ...
    <tbody>
      ...
      <td>{{$c->country_name}}</td>      
        <td><a href="/liststate/edit/{{$c->state_id}}"><span class="glyphicon glyphicon-pencil"></span></a>&nbsp&nbsp&nbsp|&nbsp&nbsp&nbsp<a href="/liststate/delete/{{$c->state_id}}"><span class="glyphicon glyphicon-trash"></span></a></td> 
      </tr>
      @endforeach
    </tbody>
    </table>
