      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12">
            ...
            <form class="form-horizontal" action='/listcity/{{$ps->city_id}}' method="post" align="center">
...
<fieldset>
    ...
    <tr>
     ...
     <td>   <input type="text" id="username" name="name" placeholder="Enter Location" class="input-xlarge" value="{{$ps->city_name}}"></td>
        <!--     -->
      <p></p>
</tr>
    </div>
