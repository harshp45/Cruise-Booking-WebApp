      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12">
            ...
            <form class="form-horizontal" action='/listusers' method="post" align="center">
...
<fieldset>
    ...
    {{csrf_field()}}
     ...
     <td>   <input type="text" id="username" name="fname" placeholder="Enter Name" class="input-xlarge"></td>
        <!--     -->
      <p></p>
</tr>
    </div>
    ...
    <tr>
     ...
     <td>   <input type="date" id="username" name="dob" placeholder="" class="input-xlarge"></td>
        <!--     -->
      <p></p>
</tr>
    </div>
    ...
    <tr>
     ...
     <td>   <input type="text" id="username" name="password" placeholder="" class="input-xlarge"></td>
        <!--     -->
      <p></p>
</tr>
    </div>
    ...
    <tr>
     ...
     <td>   <input type="radio" id="username" name="gender" value="Male" placeholder="" class="input-xlarge">Male&nbsp&nbsp<input type="radio" id="username" name="gender" placeholder="" value="Female" class="input-xlarge">Female</td>
        <!--     -->
      <p></p>
</tr>
    </div>
    ...
    <tr>
     ...
     <td>   <input type="text" id="username" name="mobile" placeholder="Enter Contact Details" class="input-xlarge"></td>
        <!--     -->
      <p></p>
</tr>
    </div>
